...
function Landing() {
  ...
  async function handleCashier(e: React.FormEvent) {
    ...
    try {
      // Existing database-based cashier authentication is preserved.
    ...
    <div className="min-h-screen bg-slate-50 motion-safe:animate-in motion-safe:fade-in duration-700">
      ...
      <main className="mx-auto max-w-7xl px-5 pb-24 pt-8 sm:px-8 md:pt-12">
        ...
        >
          ...
          <div
            className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-r from-white/95 via-white/55 to-transparent"
            aria-hidden="true"
          />
