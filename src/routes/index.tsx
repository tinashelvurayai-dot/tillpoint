...
/* ============================================================
   ...
   This stays behind the entire hero/glass composition.
   ============================================================ */
...
/* ============================================================
   HERO PRODUCT IMAGE
   This fills the glass frame on the right side.
   ============================================================ */
    ...
    <div className="min-h-screen bg-slate-50 motion-safe:animate-in motion-safe:fade-in duration-700">
      ...
      <main className="mx-auto max-w-7xl px-5 pb-24 pt-8 sm:px-8 md:pt-12">
        ...
        {/* ====================================================
            HERO
            IMPORTANT:
            heroGlassBackdrop remains behind the entire hero.
            ==================================================== */}
        ...
        >
          ...
          <div
            className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-r from-white/95 via-white/45 to-transparent"
            aria-hidden="true"
          />

          {/* Orange + blue atmospheric layer */}
          <div
          ...
          {/* ==================================================
              RIGHT HERO GLASS FRAME

              The creamHeroImage fills this frame.

              The heroGlassBackdrop remains behind the
              entire hero section.
              ================================================== */}
          ...
          <div className="flex min-h-[420px] flex-col items-center justify-center gap-6 motion-safe:animate-in motion-safe:slide-in-from-right-4 duration-700">
            ...
            <div className="group relative aspect-[4/3] w-full overflow-hidden rounded-[2rem] border border-white/80 bg-white/15 shadow-[0_0_0_1px_rgba(241,89,34,0.20),0_18px_38px_rgba(241,89,34,0.24),0_28px_70px_rgba(11,59,143,0.18)] backdrop-blur-[2px]">

              {/* ==================================================
                  THE ACTUAL EXO IMAGE
                  It fills the entire glass frame.
                  ================================================== */}
              ...
              <img
                ...
                className="absolute inset-0 block h-full w-full object-cover transition duration-700 group-hover:scale-[1.015]"
              />

              {/* Glass reflection */}

              <div
                className="pointer-events-none absolute inset-0 bg-gradient-to-br from-white/30 via-white/5 to-[#0b3b8f]/15"
                aria-hidden="true"
              />

              {/* Premium top glass reflection */}

              <div
                className="pointer-events-none absolute left-0 right-0 top-0 h-28 bg-gradient-to-b from-white/30 via-white/10 to-transparent"
                aria-hidden="true"
              />
              ...
              <div
                className="pointer-events-none absolute -left-1/4 top-0 h-full w-1/3 rotate-[18deg] bg-white/10 blur-2xl"
                aria-hidden="true"
              />
              ...
              <div
                className="pointer-events-none absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-[#0b3b8f]/10 to-transparent"
                aria-hidden="true"
              />
        ...
        {/* ====================================================
            PRODUCT RANGE
            The background image behind these cards is restored.
            ==================================================== */}
